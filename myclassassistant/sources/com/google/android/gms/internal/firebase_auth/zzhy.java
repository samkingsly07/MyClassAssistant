...
class zzhy<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza(comparable) >= 0 || this.zzaax.containsKey(comparable);
    }
    ...
    public V get(Object obj) {
        ...
        if (zza >= 0) {
            return this.zzaaw.get(zza).getValue();
        }
    ...
    public final V put(K k, V v) {
        ...
        int zza = zza(k);
        if (zza >= 0) {
            return this.zzaaw.get(zza).setValue(v);
        }
        zzjg();
    ...
    public final V zzbc(int i) {
        zzjg();
        V value = this.zzaaw.remove(i).getValue();
        if (!this.zzaax.isEmpty()) {
            Iterator it = zzjh().entrySet().iterator();
            this.zzaaw.add(new zzif(this, (Map.Entry) it.next()));
            it.remove();
        }
        return value;
    }
    ...
    private final int zza(K k) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = k.compareTo((Comparable) this.zzaaw.get(i2).getKey());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zzaay == null) {
            this.zzaay = new zzih(this, (zzhz) null);
        }
        return this.zzaay;
    }
    ...
    public final Set<Map.Entry<K, V>> zzjf() {
        if (this.zzaba == null) {
            this.zzaba = new zzib(this, (zzhz) null);
        }
        return this.zzaba;
    }
