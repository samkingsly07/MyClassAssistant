...
final class zzhx {
    ...
    public static void zzg(Class<?> cls) {
        if (!zzfs.class.isAssignableFrom(cls) && zzaar != null && !zzaar.isAssignableFrom(cls)) {
    ...
    static int zzt(List<Long> list) {
        ...
        if (list instanceof zzgp) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzez.zze(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzu(List<Long> list) {
        ...
        if (list instanceof zzgp) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzez.zzf(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzv(List<Long> list) {
        ...
        if (list instanceof zzgp) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzez.zzg(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzw(List<Integer> list) {
        ...
        if (list instanceof zzft) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzez.zzal(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzx(List<Integer> list) {
        ...
        if (list instanceof zzft) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzez.zzag(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzy(List<Integer> list) {
        ...
        if (list instanceof zzft) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzez.zzah(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzz(List<Integer> list) {
        ...
        if (list instanceof zzft) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzez.zzai(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzd(int i, List<zzhb> list, zzhv zzhv) {
        ...
        int i2 = 0;
        for (int i3 = 0; i3 < size; i3++) {
            i2 += zzez.zzc(i, list.get(i3), zzhv);
        }
        return i2;
    }
