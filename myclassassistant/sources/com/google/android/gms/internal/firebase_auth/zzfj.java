...
final class zzfj<FieldDescriptorType extends zzfl<FieldDescriptorType>> {
    ...
    private final void zza(FieldDescriptorType fielddescriptortype, Object obj) {
        ...
        this.zzub.put(fielddescriptortype, obj);
    }
    ...
    public final boolean isInitialized() {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zzb : this.zzub.zzje()) {
            if (!zzb(zzb)) {
                return false;
            }
        }
    ...
    public final void zza(zzfj<FieldDescriptorType> zzfj) {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zzc : zzfj.zzub.zzje()) {
            zzc(zzc);
        }
    }
    ...
    public final int zzgv() {
        ...
        for (int i2 = 0; i2 < this.zzub.zzjd(); i2++) {
            Map.Entry<FieldDescriptorType, Object> zzbb = this.zzub.zzbb(i2);
            i += zzb((zzfl<?>) (zzfl) zzbb.getKey(), zzbb.getValue());
        }
        for (Map.Entry next : this.zzub.zzje()) {
            i += zzb((zzfl<?>) (zzfl) next.getKey(), next.getValue());
        }
        return i;
    }
    ...
    public final int zzgw() {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zzd : this.zzub.zzje()) {
            i += zzd(zzd);
        }
        return i;
    }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        zzfj zzfj = new zzfj();
        for (int i = 0; i < this.zzub.zzjd(); i++) {
            Map.Entry<FieldDescriptorType, Object> zzbb = this.zzub.zzbb(i);
            zzfj.zza((zzfl) zzbb.getKey(), zzbb.getValue());
        }
        for (Map.Entry next : this.zzub.zzje()) {
            zzfj.zza((zzfl) next.getKey(), next.getValue());
        }
        zzfj.zzud = this.zzud;
        return zzfj;
    }
