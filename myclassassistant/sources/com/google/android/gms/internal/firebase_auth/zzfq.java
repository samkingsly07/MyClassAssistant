...
abstract class zzfq<T extends zzff> {
    ...
    static <T extends zzff> T zza(Class<T> cls) {
        ...
        try {
            ...
            Iterator<S> it = ServiceLoader.load(zzfq.class, classLoader).iterator();
            ...
            try {
                return (zzff) cls.getMethod("combine", new Class[]{Collection.class}).invoke((Object) null, new Object[]{arrayList});
