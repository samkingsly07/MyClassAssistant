...
final class zzgq implements zzhw {
    ...
    public final <T> zzhv<T> zze(Class<T> cls) {
        ...
        if (zzc.zzin()) {
            ...
            return zzhf.zza(cls, zzc, zzhk.zzir(), zzgl.zzie(), zzhx.zzja(), (zzfg<?>) null, zzgy.zzik());
        } else if (zza(zzc)) {
            return zzhf.zza(cls, zzc, zzhk.zziq(), zzgl.zzid(), zzhx.zziy(), zzfi.zzgt(), zzgy.zzij());
        } else {
            return zzhf.zza(cls, zzc, zzhk.zziq(), zzgl.zzid(), zzhx.zziz(), (zzfg<?>) null, zzgy.zzij());
        }
    }

    private static boolean zza(zzgz zzgz) {
        return zzgz.zzim() == zzfs.zze.zzxn;
    }

    private static zzha zzif() {
        try {
            return (zzha) Class.forName("com.google.protobuf.DescriptorMessageInfoFactory").getDeclaredMethod("getInstance", new Class[0]).invoke((Object) null, new Object[0]);
        } catch (Exception e) {
            return zzza;
        }
    }
