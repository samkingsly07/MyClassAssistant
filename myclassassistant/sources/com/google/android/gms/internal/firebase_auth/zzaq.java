...
public final class zzaq extends AbstractSafeParcelable {
    ...
    public zzaq(@SafeParcelable.Param(mo10721id = 1) @NonNull String str, @SafeParcelable.Param(mo10721id = 2) @NonNull String str2, @Nullable @SafeParcelable.Param(mo10721id = 3) String str3) {
        this.zzgh = str;
        this.zzgi = str2;
        this.zzgw = str3;
    }
