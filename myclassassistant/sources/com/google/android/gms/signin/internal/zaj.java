...
public final class zaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo10718id = 2)
    private final ConnectionResult zadh;
    @SafeParcelable.VersionField(mo10724id = 1)
    private final int zale;
    @SafeParcelable.Field(getter = "getResolveAccountResponse", mo10718id = 3)
    private final ResolveAccountResponse zasb;

    @SafeParcelable.Constructor
    zaj(@SafeParcelable.Param(mo10721id = 1) int i, @SafeParcelable.Param(mo10721id = 2) ConnectionResult connectionResult, @SafeParcelable.Param(mo10721id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zale = i;
