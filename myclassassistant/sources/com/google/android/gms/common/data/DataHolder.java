...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.VersionField(mo10724id = 1000)
    private final int zale;
    @SafeParcelable.Field(getter = "getColumns", mo10718id = 1)
    private final String[] zalp;
    private Bundle zalq;
    @SafeParcelable.Field(getter = "getWindows", mo10718id = 2)
    private final CursorWindow[] zalr;
    @SafeParcelable.Field(getter = "getStatusCode", mo10718id = 3)
    private final int zals;
    @SafeParcelable.Field(getter = "getMetadata", mo10718id = 4)
    ...
    DataHolder(@SafeParcelable.Param(mo10721id = 1000) int i, @SafeParcelable.Param(mo10721id = 1) String[] strArr, @SafeParcelable.Param(mo10721id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(mo10721id = 3) int i2, @SafeParcelable.Param(mo10721id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalw = true;
        this.zale = i;
        this.zalp = strArr;
