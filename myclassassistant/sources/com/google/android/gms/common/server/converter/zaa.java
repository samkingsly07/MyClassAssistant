...
public final class zaa extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStringToIntConverter", mo10718id = 2)
    private final StringToIntConverter zapk;

    @SafeParcelable.Constructor
    zaa(@SafeParcelable.Param(mo10721id = 1) int i, @SafeParcelable.Param(mo10721id = 2) StringToIntConverter stringToIntConverter) {
        this.zale = i;
