...
public class FavaDiagnosticsEntity extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public FavaDiagnosticsEntity(@SafeParcelable.Param(mo10721id = 1) int i, @SafeParcelable.Param(mo10721id = 2) String str, @SafeParcelable.Param(mo10721id = 3) int i2) {
        this.zale = i;
        this.zapi = str;
        this.zapj = i2;
    }
