...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @SafeParcelable.VersionField(getter = "getVersionCode", mo10724id = 1)
        private final int zale;
        @SafeParcelable.Field(getter = "getTypeIn", mo10718id = 2)
        protected final int zapq;
        @SafeParcelable.Field(getter = "isTypeInArray", mo10718id = 3)
        protected final boolean zapr;
        @SafeParcelable.Field(getter = "getTypeOut", mo10718id = 4)
        protected final int zaps;
        @SafeParcelable.Field(getter = "isTypeOutArray", mo10718id = 5)
        protected final boolean zapt;
        @SafeParcelable.Field(getter = "getOutputFieldName", mo10718id = 6)
        protected final String zapu;
        @SafeParcelable.Field(getter = "getSafeParcelableFieldId", mo10718id = 7)
        protected final int zapv;
        protected final Class<? extends FastJsonResponse> zapw;
        @SafeParcelable.Field(getter = "getConcreteTypeName", mo10718id = 8)
        private final String zapx;
        private zak zapy;
        /* access modifiers changed from: private */
        @SafeParcelable.Field(getter = "getWrappedConverter", mo10718id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        public FieldConverter<I, O> zapz;

        @SafeParcelable.Constructor
        Field(@SafeParcelable.Param(mo10721id = 1) int i, @SafeParcelable.Param(mo10721id = 2) int i2, @SafeParcelable.Param(mo10721id = 3) boolean z, @SafeParcelable.Param(mo10721id = 4) int i3, @SafeParcelable.Param(mo10721id = 5) boolean z2, @SafeParcelable.Param(mo10721id = 6) String str, @SafeParcelable.Param(mo10721id = 7) int i4, @SafeParcelable.Param(mo10721id = 8) String str2, @SafeParcelable.Param(mo10721id = 9) zaa zaa) {
            this.zale = i;
            this.zapq = i2;
            this.zapr = z;
            this.zaps = i3;
