...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo10718id = 2)
    private final int zzh;
    @SafeParcelable.Field(getter = "getResolution", mo10718id = 3)
    private final PendingIntent zzi;
    @SafeParcelable.Field(getter = "getErrorMessage", mo10718id = 4)
    private final String zzj;

    @SafeParcelable.Constructor
    ConnectionResult(@SafeParcelable.Param(mo10721id = 1) int i, @SafeParcelable.Param(mo10721id = 2) int i2, @SafeParcelable.Param(mo10721id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo10721id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
