    ...
    public void registerEvent(Context context, String str, int i, String str2, String str3, String str4, int i2, List<String> list, long j) {
        ...
        if (zzgc.booleanValue()) {
            if (TextUtils.isEmpty(str)) {
                ...
                WakeLockEvent wakeLockEvent2 = new WakeLockEvent(currentTimeMillis, i3, str2, i2, list3, str, elapsedRealtime, zzg, str3, "com.google.android.gms".equals(packageName) ? null : packageName, zza.zzh(context), j, str4);
                try {
