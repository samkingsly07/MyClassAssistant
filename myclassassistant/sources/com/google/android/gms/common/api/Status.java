...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStatusCode", mo10718id = 1)
    private final int zzh;
    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", mo10718id = 3)
    private final PendingIntent zzi;
    @Nullable
    @SafeParcelable.Field(getter = "getStatusMessage", mo10718id = 2)
    private final String zzj;

    @SafeParcelable.Constructor
    @KeepForSdk
    Status(@SafeParcelable.Param(mo10721id = 1000) int i, @SafeParcelable.Param(mo10721id = 1) int i2, @Nullable @SafeParcelable.Param(mo10721id = 2) String str, @Nullable @SafeParcelable.Param(mo10721id = 3) PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;
