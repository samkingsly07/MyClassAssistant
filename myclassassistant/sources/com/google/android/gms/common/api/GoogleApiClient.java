...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public final GoogleApiClient build() {
            ...
            zaaw zaaw = new zaaw(this.mContext, new ReentrantLock(), this.zabj, clientSettings, this.zacc, this.zacd, arrayMap, this.zace, this.zacf, arrayMap2, this.zaca, zaaw.zaa(arrayMap2.values(), true), arrayList, false);
