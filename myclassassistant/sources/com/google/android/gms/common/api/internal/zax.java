...
public final class zax implements zabs {
    ...
    public zax(Context context, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map<Api.AnyClientKey<?>, Api.Client> map, ClientSettings clientSettings, Map<Api<?>, Boolean> map2, Api.AbstractClientBuilder<? extends zad, SignInOptions> abstractClientBuilder, ArrayList<zaq> arrayList, zaaw zaaw, boolean z) {
        ...
        for (Map.Entry next2 : map.entrySet()) {
            ...
            zaw zaw2 = new zaw(context, api, looper2, client, (zaq) hashMap2.get(api), clientSettings2, abstractClientBuilder);
    ...
    private final boolean zaac() {
        /*
            ...
            r0.lock()
            boolean r0 = r3.zafc     // Catch:{ all -> 0x0046 }
            r1 = 0
            if (r0 == 0) goto L_0x0040
            boolean r0 = r3.zaez     // Catch:{ all -> 0x0046 }
            if (r0 != 0) goto L_0x000f
            goto L_0x0040
        L_0x000f:
            java.util.Map<com.google.android.gms.common.api.Api$AnyClientKey<?>, com.google.android.gms.common.api.internal.zaw<?>> r0 = r3.zaeu     // Catch:{ all -> 0x0046 }
