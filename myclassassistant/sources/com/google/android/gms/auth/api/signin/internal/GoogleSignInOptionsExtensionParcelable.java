...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBundle", mo10718id = 3)
    private Bundle mBundle;
    @SafeParcelable.Field(getter = "getType", mo10718id = 2)
    private int mType;
    @SafeParcelable.VersionField(mo10724id = 1)
    private final int versionCode;

    @SafeParcelable.Constructor
    GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(mo10721id = 1) int i, @SafeParcelable.Param(mo10721id = 2) int i2, @SafeParcelable.Param(mo10721id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }
