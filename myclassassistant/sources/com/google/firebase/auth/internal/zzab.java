...
final class zzab {
    ...
    public static Map<String, Object> zzcv(@NonNull String str) {
        ...
        if (split.length < 2) {
            ...
            logger.mo10771e(valueOf.length() != 0 ? "Invalid idToken ".concat(valueOf) : new String("Invalid idToken "), new Object[0]);
            return Collections.EMPTY_MAP;
        }
        try {
            Map<String, Object> zzcw = zzcw(new String(Base64Utils.decodeUrlSafeNoPadding(split[1]), "UTF-8"));
            return zzcw == null ? Collections.EMPTY_MAP : zzcw;
        } catch (UnsupportedEncodingException e) {
            zzgg.mo10770e("Unable to decode token", e, new Object[0]);
            return Collections.EMPTY_MAP;
        }
    }
