...
public final class zzad {
    ...
    public final FirebaseUser zzeo() {
        String string = this.zzrx.getString("com.google.firebase.auth.FIREBASE_USER", (String) null);
    ...
    public final zzcz zzh(@NonNull FirebaseUser firebaseUser) {
        Preconditions.checkNotNull(firebaseUser);
        String string = this.zzrx.getString(String.format("com.google.firebase.auth.GET_TOKEN_RESPONSE.%s", new Object[]{firebaseUser.getUid()}), (String) null);
        if (string != null) {
