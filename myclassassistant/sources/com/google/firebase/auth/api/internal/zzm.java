...
final class zzm implements zzez<zzdv> {
    ...
    public final /* synthetic */ void onSuccess(@NonNull Object obj) {
        zzdv zzdv = (zzdv) obj;
        this.zzis.zza(new zzcz(zzdv.zzr(), zzdv.getIdToken(), Long.valueOf(zzdv.zzs()), "Bearer"), (String) null, (String) null, Boolean.valueOf(zzdv.isNewUser()), (zzd) null, this.zzir, this);
    }
}
