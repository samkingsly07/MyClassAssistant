...
abstract class zzeo<ResultT, CallbackT> implements zzam<zzdq, ResultT> {
    ...
    static class zza extends LifecycleCallback {
        private final List<PhoneAuthProvider.OnVerificationStateChangedCallbacks> zznw;
    ...
    public final zzeo<ResultT, CallbackT> zza(PhoneAuthProvider.OnVerificationStateChangedCallbacks onVerificationStateChangedCallbacks, Activity activity, Executor executor) {
        synchronized (this.zznh) {
            this.zznh.add((PhoneAuthProvider.OnVerificationStateChangedCallbacks) Preconditions.checkNotNull(onVerificationStateChangedCallbacks));
        }
        this.zzni = activity;
        if (this.zzni != null) {
    ...
    public final void zzc(ResultT resultt) {
        ...
        this.zznt = true;
        this.zznu = resultt;
        this.zzng.zza(resultt, (Status) null);
    }
