...
public class ActionCodeSettings extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUrl", mo10718id = 1)
    private final String url;
    @SafeParcelable.Field(getter = "getIOSBundle", mo10718id = 2)
    private final String zzfs;
    @SafeParcelable.Field(getter = "getIOSAppStoreId", mo10718id = 3)
    private final String zzft;
    @SafeParcelable.Field(getter = "getAndroidPackageName", mo10718id = 4)
    private final String zzfu;
    @SafeParcelable.Field(getter = "getAndroidInstallApp", mo10718id = 5)
    private final boolean zzfv;
    @SafeParcelable.Field(getter = "getAndroidMinimumVersion", mo10718id = 6)
    private final String zzfw;
    @SafeParcelable.Field(getter = "canHandleCodeInApp", mo10718id = 7)
    private final boolean zzfx;
    @SafeParcelable.Field(getter = "getLocaleHeader", mo10718id = 8)
    private String zzfy;
    @SafeParcelable.Field(getter = "getRequestType", mo10718id = 9)
    private int zzfz;
    @SafeParcelable.Field(getter = "getDynamicLinkDomain", mo10718id = 10)
    private String zzga;

    @SafeParcelable.Constructor
    ActionCodeSettings(@SafeParcelable.Param(mo10721id = 1) String str, @SafeParcelable.Param(mo10721id = 2) String str2, @SafeParcelable.Param(mo10721id = 3) String str3, @SafeParcelable.Param(mo10721id = 4) String str4, @SafeParcelable.Param(mo10721id = 5) boolean z, @SafeParcelable.Param(mo10721id = 6) String str5, @SafeParcelable.Param(mo10721id = 7) boolean z2, @SafeParcelable.Param(mo10721id = 8) String str6, @SafeParcelable.Param(mo10721id = 9) int i, @SafeParcelable.Param(mo10721id = 10) String str7) {
        this.url = str;
        this.zzfs = str2;
        this.zzft = str3;
        this.zzfu = str4;
