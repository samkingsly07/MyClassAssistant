...
public class FirebaseDatabase {
    ...
    public static synchronized FirebaseDatabase getInstance(@NonNull FirebaseApp app2, @NonNull String url) {
        ...
        synchronized (FirebaseDatabase.class) {
            ...
            Map<RepoInfo, FirebaseDatabase> instances = databaseInstances.get(app2.getName());
            if (instances == null) {
                instances = new HashMap<>();
                databaseInstances.put(app2.getName(), instances);
            }
            ...
            database = instances.get(parsedUrl.repoInfo);
            if (database == null) {
