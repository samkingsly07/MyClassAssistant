...
public class PersistentConnectionImpl implements Connection.Delegate, PersistentConnection {
    ...
    public void onDisconnect(Connection.DisconnectReason reason) {
        ...
        if (shouldReconnect()) {
            ...
            if (this.lastConnectionEstablishedTime > 0 && timeSinceLastConnectSucceeded > SUCCESSFUL_CONNECTION_ESTABLISHED_DELAY) {
                lastConnectionWasSuccessful = true;
            }
            boolean lastConnectionWasSuccessful2 = lastConnectionWasSuccessful;
            if (reason == Connection.DisconnectReason.SERVER_RESET || lastConnectionWasSuccessful2) {
