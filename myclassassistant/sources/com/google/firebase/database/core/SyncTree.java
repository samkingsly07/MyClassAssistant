        ...
        return (List) this.persistenceManager.runInTransaction(new Callable<List<? extends Event>>() {
            ...
            public List<? extends Event> call() {
                ...
                if (serverCacheNode != null) {
                    ...
                    serverCache = SyncTree.this.persistenceManager.serverCache(query);
                    if (serverCache.isFullyInitialized()) {
                        CacheNode cacheNode = serverCache;
                    } else {
                        ...
                        for (NamedNode child2 : serverCache.getNode()) {
                        ...
                        serverCache = new CacheNode(IndexedNode.from(serverCacheNode2, query.getIndex()), false, false);
                    }
                }
