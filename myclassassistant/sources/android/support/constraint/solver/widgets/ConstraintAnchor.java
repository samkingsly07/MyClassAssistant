    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor anchor) {
        ...
        switch (this.mType) {
            ...
            case NONE:
                return false;
            case LEFT:
                int i = C00361.f4x1d400623[anchor.getType().ordinal()];
                if (i == 3 || i == 7) {
                    return true;
                }
                return false;
            case RIGHT:
                int i2 = C00361.f4x1d400623[anchor.getType().ordinal()];
                if (i2 == 2 || i2 == 7) {
                    return true;
                }
                return false;
            case TOP:
                int i3 = C00361.f4x1d400623[anchor.getType().ordinal()];
                if (i3 == 5 || i3 == 8) {
                    return true;
                }
                return false;
            case BOTTOM:
                int i4 = C00361.f4x1d400623[anchor.getType().ordinal()];
                if (i4 == 4 || i4 == 8) {
                    return true;
                }
                return false;
