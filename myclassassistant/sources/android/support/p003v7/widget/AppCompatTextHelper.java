...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(android.util.AttributeSet r19, int r20) {
        /*
            ...
            int[] r5 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextHelper
            r6 = 0
            ...
            int r7 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextHelper_android_textAppearance
            r8 = -1
            int r7 = r5.getResourceId(r7, r8)
            int r9 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextHelper_android_drawableLeft
        ...
        L_0x0032:
            int r9 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextHelper_android_drawableTop
            boolean r9 = r5.hasValue(r9)
        ...
        L_0x0046:
            int r9 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextHelper_android_drawableRight
            boolean r9 = r5.hasValue(r9)
        ...
        L_0x005a:
            int r9 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextHelper_android_drawableBottom
            boolean r9 = r5.hasValue(r9)
        ...
        L_0x006e:
            ...
            int r9 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextHelper_android_drawableStart
            boolean r9 = r5.hasValue(r9)
        ...
        L_0x0088:
            int r9 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextHelper_android_drawableEnd
            boolean r9 = r5.hasValue(r9)
        ...
        L_0x009c:
            ...
            int[] r8 = android.support.p003v7.appcompat.C0400R.styleable.TextAppearance
            ...
            int r8 = android.support.p003v7.appcompat.C0400R.styleable.TextAppearance_textAllCaps
            boolean r8 = r5.hasValue(r8)
            if (r8 == 0) goto L_0x00c8
            r8 = 1
            int r11 = android.support.p003v7.appcompat.C0400R.styleable.TextAppearance_textAllCaps
        ...
        L_0x00c8:
            ...
            int r8 = android.support.p003v7.appcompat.C0400R.styleable.TextAppearance_android_textColor
            boolean r8 = r5.hasValue(r8)
            if (r8 == 0) goto L_0x00dd
            int r8 = android.support.p003v7.appcompat.C0400R.styleable.TextAppearance_android_textColor
            android.content.res.ColorStateList r12 = r5.getColorStateList(r8)
        L_0x00dd:
            int r8 = android.support.p003v7.appcompat.C0400R.styleable.TextAppearance_android_textColorHint
            boolean r8 = r5.hasValue(r8)
            if (r8 == 0) goto L_0x00eb
            int r8 = android.support.p003v7.appcompat.C0400R.styleable.TextAppearance_android_textColorHint
            android.content.res.ColorStateList r13 = r5.getColorStateList(r8)
        L_0x00eb:
            int r8 = android.support.p003v7.appcompat.C0400R.styleable.TextAppearance_android_textColorLink
            boolean r8 = r5.hasValue(r8)
        ...
        L_0x0144:
            ...
            int r8 = android.support.p003v7.appcompat.C0400R.styleable.TextAppearance_android_textSize
            boolean r8 = r5.hasValue(r8)
        ...
        L_0x01df:
            ...
            r17 = r5
        L_0x01e3:
            int[] r2 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextView
            ...
            int r4 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextView_firstBaselineToTopHeight
            r5 = -1
            int r4 = r2.getDimensionPixelSize(r4, r5)
            int r6 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextView_lastBaselineToBottomHeight
            int r6 = r2.getDimensionPixelSize(r6, r5)
            int r8 = android.support.p003v7.appcompat.C0400R.styleable.AppCompatTextView_lineHeight
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        this.mStyle = a.getInt(C0400R.styleable.TextAppearance_android_textStyle, this.mStyle);
        boolean z = true;
        if (a.hasValue(C0400R.styleable.TextAppearance_android_fontFamily) || a.hasValue(C0400R.styleable.TextAppearance_fontFamily)) {
            this.mFontTypeface = null;
            int fontFamilyId = a.hasValue(C0400R.styleable.TextAppearance_fontFamily) ? C0400R.styleable.TextAppearance_fontFamily : C0400R.styleable.TextAppearance_android_fontFamily;
        ...
        } else if (a.hasValue(C0400R.styleable.TextAppearance_android_typeface)) {
            this.mAsyncFontPending = false;
            switch (a.getInt(C0400R.styleable.TextAppearance_android_typeface, 1)) {
                case 1:
    ...
    public void onSetTextAppearance(Context context, int resId) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, resId, C0400R.styleable.TextAppearance);
        if (a.hasValue(C0400R.styleable.TextAppearance_textAllCaps)) {
            setAllCaps(a.getBoolean(C0400R.styleable.TextAppearance_textAllCaps, false));
        }
        if (Build.VERSION.SDK_INT < 23 && a.hasValue(C0400R.styleable.TextAppearance_android_textColor) && (textColor = a.getColorStateList(C0400R.styleable.TextAppearance_android_textColor)) != null) {
            this.mView.setTextColor(textColor);
        }
        if (a.hasValue(C0400R.styleable.TextAppearance_android_textSize) && a.getDimensionPixelSize(C0400R.styleable.TextAppearance_android_textSize, -1) == 0) {
