...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0400R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0400R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0400R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0400R.styleable.ActionBar_height, -1);
        if (getId() == C0400R.C0402id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0400R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        boolean z = false;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0400R.C0402id.action_bar);
        this.mContextView = findViewById(C0400R.C0402id.action_context_bar);
    }
