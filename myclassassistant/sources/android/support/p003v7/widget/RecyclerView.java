...
import android.support.p003v7.recyclerview.C0406R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attributeSet != null) {
            TypedArray a2 = context2.obtainStyledAttributes(attributeSet, C0406R.styleable.RecyclerView, i, 0);
            String layoutManagerName = a2.getString(C0406R.styleable.RecyclerView_layoutManager);
            int descendantFocusability = a2.getInt(C0406R.styleable.RecyclerView_android_descendantFocusability, -1);
            if (descendantFocusability == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a2.getBoolean(C0406R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0406R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0406R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0406R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0406R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    public void smoothScrollBy(@C0025Px int dx, @C0025Px int dy) {
        smoothScrollBy(dx, dy, (Interpolator) null);
    }

    public void smoothScrollBy(@C0025Px int dx, @C0025Px int dy, @Nullable Interpolator interpolator) {
        if (this.mLayout == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutFrozen) {
    ...
    public void offsetChildrenVertical(@C0025Px int dy) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i = 0; i < childCount; i++) {
    ...
    public void offsetChildrenHorizontal(@C0025Px int dx) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i = 0; i < childCount; i++) {
    ...
    public void onScrolled(@C0025Px int dx, @C0025Px int dy) {
    }
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0406R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0406R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0406R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0406R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0406R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0406R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0406R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0406R.dimen.fastscroll_margin));
    }
    ...
    public static abstract class SmoothScroller {
        ...
        /* access modifiers changed from: protected */
        public abstract void onSeekTargetStep(@C0025Px int i, @C0025Px int i2, @NonNull State state, @NonNull Action action);
        ...
        public static class Action {
            ...
            public Action(@C0025Px int dx, @C0025Px int dy) {
                this(dx, dy, Integer.MIN_VALUE, (Interpolator) null);
            }

            public Action(@C0025Px int dx, @C0025Px int dy, int duration) {
                this(dx, dy, duration, (Interpolator) null);
            }

            public Action(@C0025Px int dx, @C0025Px int dy, int duration, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@C0025Px int dx) {
                this.mChanged = true;
                this.mDx = dx;
            }
            ...
            public void setDy(@C0025Px int dy) {
                this.mChanged = true;
                this.mDy = dy;
            }
            ...
            public void update(@C0025Px int dx, @C0025Px int dy, int duration, @Nullable Interpolator interpolator) {
                this.mDx = dx;
                this.mDy = dy;
                this.mDuration = duration;
                this.mInterpolator = interpolator;
