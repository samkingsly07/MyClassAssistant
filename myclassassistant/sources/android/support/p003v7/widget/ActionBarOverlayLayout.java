...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static final int[] ATTRS = {C0400R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0400R.C0402id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0400R.C0402id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0400R.C0402id.action_bar));
        }
    }
