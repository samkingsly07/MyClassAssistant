...
public class DefaultItemAnimator extends SimpleItemAnimator {
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            if (additionsPending) {
                ...
                if (removalsPending || movesPending || changesPending) {
                    ...
                    ViewCompat.postOnAnimationDelayed(additions.get(0).itemView, adder, removeDuration + Math.max(moveDuration, changeDuration));
                    return;
                }
                adder.run();
    ...
    public void animateMoveImpl(RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        C04566 r0 = new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
