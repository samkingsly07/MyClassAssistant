    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0400R.C0402id.topPanel) {
                    topPanel = child;
                } else if (id == C0400R.C0402id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0400R.C0402id.contentPanel && id != C0400R.C0402id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
