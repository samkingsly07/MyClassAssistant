...
class StateListDrawable extends DrawableContainer {
    ...
    public void inflate(@NonNull Context context, @NonNull Resources r, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray a = TypedArrayUtils.obtainAttributes(r, theme, attrs, C0400R.styleable.StateListDrawable);
        setVisible(a.getBoolean(C0400R.styleable.StateListDrawable_android_visible, true), true);
    ...
    private void updateStateFromTypedArray(TypedArray a) {
        ...
        state.mVariablePadding = a.getBoolean(C0400R.styleable.StateListDrawable_android_variablePadding, state.mVariablePadding);
        state.mConstantSize = a.getBoolean(C0400R.styleable.StateListDrawable_android_constantSize, state.mConstantSize);
        state.mEnterFadeDuration = a.getInt(C0400R.styleable.StateListDrawable_android_enterFadeDuration, state.mEnterFadeDuration);
        state.mExitFadeDuration = a.getInt(C0400R.styleable.StateListDrawable_android_exitFadeDuration, state.mExitFadeDuration);
        state.mDither = a.getBoolean(C0400R.styleable.StateListDrawable_android_dither, state.mDither);
    }
    ...
    private void inflateChildElements(Context context, Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (type2 == 2 && depth2 <= innerDepth && parser.getName().equals("item")) {
                TypedArray a = TypedArrayUtils.obtainAttributes(r, theme, attributeSet, C0400R.styleable.StateListDrawableItem);
                Drawable dr = null;
                int drawableId = a.getResourceId(C0400R.styleable.StateListDrawableItem_android_drawable, -1);
                if (drawableId > 0) {
