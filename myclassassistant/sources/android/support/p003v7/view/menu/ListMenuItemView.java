...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0400R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0400R.styleable.MenuView, defStyleAttr, 0);
        this.mBackground = a.getDrawable(C0400R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0400R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0400R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = a.getDrawable(C0400R.styleable.MenuView_subMenuArrow);
        TypedArray b = context.getTheme().obtainStyledAttributes((AttributeSet) null, new int[]{16843049}, C0400R.attr.dropDownListViewStyle, 0);
    ...
    public void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0400R.C0402id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0400R.C0402id.shortcut);
        this.mSubMenuArrowView = (ImageView) findViewById(C0400R.C0402id.submenuarrow);
        if (this.mSubMenuArrowView != null) {
            this.mSubMenuArrowView.setImageDrawable(this.mSubMenuArrow);
        }
        this.mGroupDivider = (ImageView) findViewById(C0400R.C0402id.group_divider);
        this.mContent = (LinearLayout) findViewById(C0400R.C0402id.content);
    }
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0400R.layout.abc_list_menu_item_icon, this, false);
        addContentView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0400R.layout.abc_list_menu_item_radio, this, false);
        addContentView(this.mRadioButton);
    }

    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0400R.layout.abc_list_menu_item_checkbox, this, false);
