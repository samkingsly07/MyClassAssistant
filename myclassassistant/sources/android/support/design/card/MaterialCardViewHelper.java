...
class MaterialCardViewHelper {
    ...
    public void loadFromAttributes(TypedArray attributes) {
        this.strokeColor = attributes.getColor(C0052R.styleable.MaterialCardView_strokeColor, -1);
        this.strokeWidth = attributes.getDimensionPixelSize(C0052R.styleable.MaterialCardView_strokeWidth, 0);
        updateForeground();
