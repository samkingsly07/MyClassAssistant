...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.iconSize = context.getResources().getDimensionPixelSize(C0052R.dimen.design_navigation_icon_size);
        this.textView = (CheckedTextView) findViewById(C0052R.C0054id.design_menu_item_text);
    ...
    private void setActionView(View actionView) {
        if (actionView != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C0052R.C0054id.design_menu_item_action_area_stub)).inflate();
            }
            this.actionArea.removeAllViews();
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0400R.attr.colorControlHighlight, value, true)) {
            return null;
        }
    ...
    public void setIcon(Drawable icon) {
        if (icon != null) {
            ...
            if (this.emptyDrawable == null) {
                this.emptyDrawable = ResourcesCompat.getDrawable(getResources(), C0052R.C0053drawable.navigation_empty_icon, getContext().getTheme());
                if (this.emptyDrawable != null) {
