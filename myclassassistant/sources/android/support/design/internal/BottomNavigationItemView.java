...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundResource(C0052R.C0053drawable.design_bottom_navigation_item_background);
        this.defaultMargin = res.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0052R.C0054id.icon);
        this.smallLabel = (TextView) findViewById(C0052R.C0054id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0052R.C0054id.largeLabel);
