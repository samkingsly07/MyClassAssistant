...
import android.support.annotation.C0025Px;
...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    public static android.support.design.chip.ChipDrawable createFromResource(android.content.Context r5, @android.support.annotation.XmlRes int r6) {
        ...
        L_0x0030:
            ...
            int r4 = android.support.design.C0052R.style.Widget_MaterialComponents_Chip_Entry     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
            r3 = r4
        L_0x003d:
            int r4 = android.support.design.C0052R.attr.chipStandaloneStyle     // Catch:{ IOException | XmlPullParserException -> 0x0044 }
    ...
    private void loadFromAttributes(AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(this.context, attrs, C0052R.styleable.Chip, defStyleAttr, defStyleRes, new int[0]);
        setChipBackgroundColor(MaterialResources.getColorStateList(this.context, a, C0052R.styleable.Chip_chipBackgroundColor));
        setChipMinHeight(a.getDimension(C0052R.styleable.Chip_chipMinHeight, 0.0f));
        setChipCornerRadius(a.getDimension(C0052R.styleable.Chip_chipCornerRadius, 0.0f));
        setChipStrokeColor(MaterialResources.getColorStateList(this.context, a, C0052R.styleable.Chip_chipStrokeColor));
        setChipStrokeWidth(a.getDimension(C0052R.styleable.Chip_chipStrokeWidth, 0.0f));
        setRippleColor(MaterialResources.getColorStateList(this.context, a, C0052R.styleable.Chip_rippleColor));
        setText(a.getText(C0052R.styleable.Chip_android_text));
        setTextAppearance(MaterialResources.getTextAppearance(this.context, a, C0052R.styleable.Chip_android_textAppearance));
        switch (a.getInt(C0052R.styleable.Chip_android_ellipsize, 0)) {
            case 1:
        ...
        setChipIconVisible(a.getBoolean(C0052R.styleable.Chip_chipIconVisible, false));
        if (!(attrs == null || attrs.getAttributeValue(NAMESPACE_APP, "chipIconEnabled") == null || attrs.getAttributeValue(NAMESPACE_APP, "chipIconVisible") != null)) {
            setChipIconVisible(a.getBoolean(C0052R.styleable.Chip_chipIconEnabled, false));
        }
        setChipIcon(MaterialResources.getDrawable(this.context, a, C0052R.styleable.Chip_chipIcon));
        setChipIconTint(MaterialResources.getColorStateList(this.context, a, C0052R.styleable.Chip_chipIconTint));
        setChipIconSize(a.getDimension(C0052R.styleable.Chip_chipIconSize, 0.0f));
        setCloseIconVisible(a.getBoolean(C0052R.styleable.Chip_closeIconVisible, false));
        if (!(attrs == null || attrs.getAttributeValue(NAMESPACE_APP, "closeIconEnabled") == null || attrs.getAttributeValue(NAMESPACE_APP, "closeIconVisible") != null)) {
            setCloseIconVisible(a.getBoolean(C0052R.styleable.Chip_closeIconEnabled, false));
        }
        setCloseIcon(MaterialResources.getDrawable(this.context, a, C0052R.styleable.Chip_closeIcon));
        setCloseIconTint(MaterialResources.getColorStateList(this.context, a, C0052R.styleable.Chip_closeIconTint));
        setCloseIconSize(a.getDimension(C0052R.styleable.Chip_closeIconSize, 0.0f));
        setCheckable(a.getBoolean(C0052R.styleable.Chip_android_checkable, false));
        setCheckedIconVisible(a.getBoolean(C0052R.styleable.Chip_checkedIconVisible, false));
        if (!(attrs == null || attrs.getAttributeValue(NAMESPACE_APP, "checkedIconEnabled") == null || attrs.getAttributeValue(NAMESPACE_APP, "checkedIconVisible") != null)) {
            setCheckedIconVisible(a.getBoolean(C0052R.styleable.Chip_checkedIconEnabled, false));
        }
        setCheckedIcon(MaterialResources.getDrawable(this.context, a, C0052R.styleable.Chip_checkedIcon));
        setShowMotionSpec(MotionSpec.createFromAttribute(this.context, a, C0052R.styleable.Chip_showMotionSpec));
        setHideMotionSpec(MotionSpec.createFromAttribute(this.context, a, C0052R.styleable.Chip_hideMotionSpec));
        setChipStartPadding(a.getDimension(C0052R.styleable.Chip_chipStartPadding, 0.0f));
        setIconStartPadding(a.getDimension(C0052R.styleable.Chip_iconStartPadding, 0.0f));
        setIconEndPadding(a.getDimension(C0052R.styleable.Chip_iconEndPadding, 0.0f));
        setTextStartPadding(a.getDimension(C0052R.styleable.Chip_textStartPadding, 0.0f));
        setTextEndPadding(a.getDimension(C0052R.styleable.Chip_textEndPadding, 0.0f));
        setCloseIconStartPadding(a.getDimension(C0052R.styleable.Chip_closeIconStartPadding, 0.0f));
        setCloseIconEndPadding(a.getDimension(C0052R.styleable.Chip_closeIconEndPadding, 0.0f));
        setChipEndPadding(a.getDimension(C0052R.styleable.Chip_chipEndPadding, 0.0f));
        setMaxWidth(a.getDimensionPixelSize(C0052R.styleable.Chip_android_maxWidth, Integer.MAX_VALUE));
        a.recycle();
    }
    ...
    public void setMaxWidth(@C0025Px int maxWidth2) {
