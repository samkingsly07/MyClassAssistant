...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate {
    ...
    public Chip(Context context, AttributeSet attrs) {
        this(context, attrs, C0052R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ChipDrawable drawable = ChipDrawable.createFromAttributes(context, attrs, defStyleAttr, C0052R.style.Widget_MaterialComponents_Chip_Action);
    ...
    public void setMaxWidth(@C0025Px int maxWidth) {
        ...
        public void onPopulateNodeForVirtualView(int virtualViewId, AccessibilityNodeInfoCompat node) {
            if (Chip.this.hasCloseIcon()) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i = C0052R.string.mtrl_chip_close_icon_content_description;
