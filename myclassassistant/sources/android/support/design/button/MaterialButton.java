...
public class MaterialButton extends AppCompatButton {
    ...
    public MaterialButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0052R.attr.materialButtonStyle);
    }

    public MaterialButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0052R.styleable.MaterialButton, defStyleAttr, C0052R.style.Widget_MaterialComponents_Button, new int[0]);
        this.iconPadding = attributes.getDimensionPixelSize(C0052R.styleable.MaterialButton_iconPadding, 0);
        this.iconTintMode = ViewUtils.parseTintMode(attributes.getInt(C0052R.styleable.MaterialButton_iconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.iconTint = MaterialResources.getColorStateList(getContext(), attributes, C0052R.styleable.MaterialButton_iconTint);
        this.icon = MaterialResources.getDrawable(getContext(), attributes, C0052R.styleable.MaterialButton_icon);
        this.iconGravity = attributes.getInteger(C0052R.styleable.MaterialButton_iconGravity, 1);
        this.iconSize = attributes.getDimensionPixelSize(C0052R.styleable.MaterialButton_iconSize, 0);
    ...
    public void setIconPadding(@C0025Px int iconPadding2) {
    ...
    public void setIconSize(@C0025Px int iconSize2) {
        if (iconSize2 < 0) {
    ...
    public void setStrokeWidth(@C0025Px int strokeWidth) {
        if (isUsingOriginalBackground()) {
    ...
    public void setCornerRadius(@C0025Px int cornerRadius) {
        if (isUsingOriginalBackground()) {
