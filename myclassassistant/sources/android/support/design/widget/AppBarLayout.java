...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0052R.styleable.AppBarLayout, 0, C0052R.style.Widget_Design_AppBarLayout, new int[0]);
        ...
        if (Build.VERSION.SDK_INT >= 21 && a.hasValue(C0052R.styleable.AppBarLayout_elevation)) {
        ...
        this.liftOnScroll = a.getBoolean(C0052R.styleable.AppBarLayout_liftOnScroll, false);
        a.recycle();
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.liftable ? C0052R.attr.state_liftable : -C0052R.attr.state_liftable;
        extraStates[1] = (!this.liftable || !this.lifted) ? -C0052R.attr.state_lifted : C0052R.attr.state_lifted;
        extraStates[2] = this.liftable ? C0052R.attr.state_collapsible : -C0052R.attr.state_collapsible;
        extraStates[3] = (!this.liftable || !this.lifted) ? -C0052R.attr.state_collapsed : C0052R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            this.scrollFlags = a.getInt(C0052R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (a.hasValue(C0052R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = AnimationUtils.loadInterpolator(c, a.getResourceId(C0052R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            a.recycle();
        }
