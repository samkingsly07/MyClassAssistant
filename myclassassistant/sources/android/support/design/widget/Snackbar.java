...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0052R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence text, int duration) {
        ...
        SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(hasSnackbarButtonStyleAttr(parent.getContext()) ? C0052R.layout.mtrl_layout_snackbar_include : C0052R.layout.design_layout_snackbar_include, parent, false);
