...
public class BottomNavigationView extends FrameLayout {
    ...
    public BottomNavigationView(Context context, AttributeSet attrs) {
        this(context, attrs, C0052R.attr.bottomNavigationStyle);
    }
    ...
    public BottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = ThemeEnforcement.obtainTintedStyledAttributes(context, attrs, C0052R.styleable.BottomNavigationView, defStyleAttr, C0052R.style.Widget_Design_BottomNavigationView, C0052R.styleable.BottomNavigationView_itemTextAppearanceInactive, C0052R.styleable.BottomNavigationView_itemTextAppearanceActive);
        if (a.hasValue(C0052R.styleable.BottomNavigationView_itemIconTint)) {
            this.menuView.setIconTintList(a.getColorStateList(C0052R.styleable.BottomNavigationView_itemIconTint));
        } else {
            this.menuView.setIconTintList(this.menuView.createDefaultColorStateList(16842808));
        }
        setItemIconSize(a.getDimensionPixelSize(C0052R.styleable.BottomNavigationView_itemIconSize, getResources().getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_icon_size)));
        if (a.hasValue(C0052R.styleable.BottomNavigationView_itemTextAppearanceInactive)) {
            setItemTextAppearanceInactive(a.getResourceId(C0052R.styleable.BottomNavigationView_itemTextAppearanceInactive, 0));
        }
        if (a.hasValue(C0052R.styleable.BottomNavigationView_itemTextAppearanceActive)) {
            setItemTextAppearanceActive(a.getResourceId(C0052R.styleable.BottomNavigationView_itemTextAppearanceActive, 0));
        }
        if (a.hasValue(C0052R.styleable.BottomNavigationView_itemTextColor)) {
            setItemTextColor(a.getColorStateList(C0052R.styleable.BottomNavigationView_itemTextColor));
        }
        ...
        setLabelVisibilityMode(a.getInteger(C0052R.styleable.BottomNavigationView_labelVisibilityMode, -1));
        setItemHorizontalTranslationEnabled(a.getBoolean(C0052R.styleable.BottomNavigationView_itemHorizontalTranslationEnabled, true));
        this.menuView.setItemBackgroundRes(a.getResourceId(C0052R.styleable.BottomNavigationView_itemBackground, 0));
    ...
    private void addCompatibilityTopDivider(Context context) {
        ...
        divider.setLayoutParams(new FrameLayout.LayoutParams(-1, getResources().getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_shadow_height)));
        addView(divider);
    }
