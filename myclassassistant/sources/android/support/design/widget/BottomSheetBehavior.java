...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        setFitToContents(a.getBoolean(C0052R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (this.peekHeightAuto) {
            if (this.peekHeightMin == 0) {
                this.peekHeightMin = parent.getResources().getDimensionPixelSize(C0052R.dimen.design_bottom_sheet_peek_height_min);
            }
