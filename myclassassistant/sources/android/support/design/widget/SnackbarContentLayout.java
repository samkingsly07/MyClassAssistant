...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attrs) {
        ...
        this.maxWidth = a.getDimensionPixelSize(C0052R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.maxInlineActionWidth = a.getDimensionPixelSize(C0052R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
        a.recycle();
    }
    ...
    public void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C0052R.C0054id.snackbar_text);
        this.actionView = (Button) findViewById(C0052R.C0054id.snackbar_action);
    }
