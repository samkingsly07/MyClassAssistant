...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0052R.layout.design_bottom_sheet_dialog, (ViewGroup) null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0052R.C0054id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0052R.C0054id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0052R.C0054id.touch_outside).setOnClickListener(new View.OnClickListener() {
