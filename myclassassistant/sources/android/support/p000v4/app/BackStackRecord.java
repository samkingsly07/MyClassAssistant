...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    @Nullable
    String mName;
    ArrayList<C0218Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0218Op {
        ...
        C0218Op(int cmd2, Fragment fragment2) {
            this.cmd = cmd2;
    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                C0218Op op = this.mOps.get(opNum);
                switch (op.cmd) {
                    case 0:
                        cmdStr = "NULL";
                        break;
            ...
            if (!(container == 0 || container == lastContainer)) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    for (int thoseOpIndex = 0; thoseOpIndex < numThoseOps; thoseOpIndex++) {
                        C0218Op thatOp = record.mOps.get(thoseOpIndex);
            ...
            switch (op.cmd) {
                        ...
                        if (old.mContainerId == containerId) {
                            if (old == f) {
                                ...
                                if (old == oldPrimaryNav) {
                                    this.mOps.add(opNum, new C0218Op(9, old));
                                    opNum++;
                                    oldPrimaryNav = null;
                                }
                                C0218Op removeOp = new C0218Op(3, old);
                ...
                case 6:
                    ...
                    if (op.fragment != oldPrimaryNav) {
                        ...
                        this.mOps.add(opNum, new C0218Op(9, op.fragment));
                        opNum++;
                        oldPrimaryNav = null;
                        break;
                    }
                case 8:
                    this.mOps.add(opNum, new C0218Op(9, oldPrimaryNav));
                    opNum++;
    ...
    private static boolean isFragmentPostponed(C0218Op op) {
