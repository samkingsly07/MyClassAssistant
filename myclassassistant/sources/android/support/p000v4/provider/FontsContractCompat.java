...
public class FontsContractCompat {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x008d, code lost:
        sBackgroundThread.postAndReply(r2, new android.support.p000v4.provider.FontsContractCompat.C03193());
     */
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int ttcIndex, @IntRange(from = 1, mo159to = 1000) int weight, boolean italic, int resultCode) {
        ...
        try {
            ...
            if (cursor3 != null && cursor3.getCount() > 0) {
                ...
                while (cursor3.moveToNext()) {
                    int resultCode = resultCodeColumnIndex != -1 ? cursor3.getInt(resultCodeColumnIndex) : 0;
                    int ttcIndex = ttcIndexColumnIndex != -1 ? cursor3.getInt(ttcIndexColumnIndex) : 0;
